...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, nSPICFG_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, nTERM_EN_Pin|LED_IO_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = UNUSED_USB_ID_PASSTHRU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(UNUSED_USB_ID_PASSTHRU_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : Unused PC0, PC1, PC2*/
  ...
  /*Configure GPIO pins : Unused PB4, PB5, PB6 */
  ...
  /*Configure GPIO pins : Secondary USB disabled PB14, PB15 */
  ...
  /*Configure GPIO pin : PA0, PA1, PA3, PtPin */
  GPIO_InitStruct.Pin = UNUSED_nULPI_RESET_Pin | GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_3;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
