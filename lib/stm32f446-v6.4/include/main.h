...
#define UNUSED_USB_ID_PASSTHRU_Pin GPIO_PIN_5
#define UNUSED_USB_ID_PASSTHRU_GPIO_Port GPIOE
#define UNUSED_PE6_Pin GPIO_PIN_6
#define UNUSED_PE6_GPIO_Port GPIOE
#define UNUSED_nULPI_RESET_Pin GPIO_PIN_2
#define UNUSED_nULPI_RESET_GPIO_Port GPIOA
